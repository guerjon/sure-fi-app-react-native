...
public class BleModule extends ReactContextBaseJavaModule {
    ...
    public void startDeviceScan(@Nullable ReadableArray filteredUUIDs, @Nullable ReadableMap options) {
        Log.d("I/ReactNativeJS:","startDeviceScan()");
        UUID[] uuids = null;
    ...
    private void safeStartDeviceScan(final UUID[] uuids) {
        Log.d("I/ReactNativeJS:","safeStartDeviceScan()");
    ...
    public void stopDeviceScan() {
        Log.d("I/ReactNativeJS:","stopDeviceScan()");
    ...
    public void writeCharacteristicForDevice(final String deviceId,
        ...
        Log.d("CRAZY",String.valueOf(deviceId));
        Log.d("CRAZY",characteristicUUID);
        Log.d("CRAZY",valueBase64);
        Log.d("CRAZY",String.valueOf(response));
        Log.d("CRAZY",transactionId);
    ...
    public void writeCharacteristicForService(final int serviceIdentifier,
        ...
        Log.d("CRAZY",String.valueOf(serviceIdentifier));
        Log.d("CRAZY",characteristicUUID);
        Log.d("CRAZY",valueBase64);
        Log.d("CRAZY",String.valueOf(response));
        Log.d("CRAZY",transactionId);
    ...
    private void writeCharacteristicWithValue(final Characteristic characteristic,
        ...
        try {
            //Log.d("DEBUG",Arrays.toString(value));
        } catch (Throwable e) {
    ...
    private void safeWriteCharacteristicForDevice(final Characteristic characteristic,
                                                  ...
                                                  final SafePromise promise) {
        int request_mtu = 25;
        UUID characteristic_uuid =characteristic.getNativeCharacteristic().getUuid();
        /*final Subscription subscription = characteristic
                ...
                .setMaxBatchSize(request_mtu) // optional -> default 20 or current MTU
                .setBytes(value)
                .build()
