			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
                    ...
                    if(array.valueAt(0) != null){
                        Log.d("BYTES", array.valueAt(0).toString() );
                        new_representation = bytesToHex(array.valueAt(0));
                    }

                        Log.i(bleManager.LOG_TAG, " ---------------------------------------------");
                        Log.i(bleManager.LOG_TAG, "DiscoverPeripheral: " + result.getDevice().getName());
                        Log.i(bleManager.LOG_TAG, "getAdvertisingSid: " + result.getDevice().getAddress());
                        Log.i(bleManager.LOG_TAG, "getManufacturerSpecificData(): " + new_representation);
                        Log.i(bleManager.LOG_TAG, " ---------------------------------------------");
