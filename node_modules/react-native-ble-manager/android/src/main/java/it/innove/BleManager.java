...
class BleManager extends ReactContextBaseJavaModule implements ActivityEventListener {
	...
	public void scan(ReadableArray serviceUUIDs, final int scanSeconds, boolean allowDuplicates, ReadableMap options, Callback callback) {
		...
		Log.d("SCAN_RECORDS",serviceUUIDs.toString() + String.valueOf(scanSeconds) + options.toString());
	...
	@ReactMethod
	public void writeWithoutResponseithoutResponse(String deviceUUID, String serviceUUID, String characteristicUUID, ReadableArray message, Integer maxByteSize, Integer queueSleepTime, Callback callback) {
				...
				public void onLeScan(final BluetoothDevice device, final int rssi,
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							Log.i(LOG_TAG, "scanRecord: " + scanRecord);
