...
class BleManager extends ReactContextBaseJavaModule implements ActivityEventListener {
	...
	@ReactMethod
	public void controllHVACConnect(String peripheralUUID,ReadableArray data,int hardware_type,Callback callback){
		Log.d("METHOD","controllHVACConnect()");
		Log.d(LOG_TAG, peripheralUUID);
		Peripheral peripheral = addPeripherial(peripheralUUID);
		byte[]decoded = decodeReadableArrayToByteArray(data);
		peripheral.controllHVACConnect(callback, getCurrentActivity(),decoded,hardware_type);
	}
