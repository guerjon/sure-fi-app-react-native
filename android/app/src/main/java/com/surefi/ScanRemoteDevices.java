...
public class ScanRemoteDevices extends ReactContextBaseJavaModule {
    ...
    public ScanRemoteDevices(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    @ReactMethod
    public void scan(final Callback callback,final Callback error_callback){
